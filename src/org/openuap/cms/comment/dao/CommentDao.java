 ...
 */
package org.openuap.cms.comment.dao;
 ...
 * 
 * <p>
 * $Id: CommentDao.java 3950 2010-11-02 09:10:01Z orangeforjava $
 * </p>
 * 
 * @author Joseph
 * @version 1.0
...
public interface CommentDao {
	...
	/**
	 * 获得平铺的指定话题评论
	 * @param indexId 内容索引id
	 * @param start 开始偏移
	 * @param len 每页长度
	 * @return
	 */	
	public List<ICommentPost> getFlatComments(String objectId,String objectType,QueryInfo qi,PageBuilder pb);
	/**
	 * 获得平铺的指定话题评论
	 * @param objectId 
	 * @param objectType
