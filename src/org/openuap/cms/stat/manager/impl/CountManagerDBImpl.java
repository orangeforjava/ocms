 ...
 */
package org.openuap.cms.stat.manager.impl;
 ...
 * 
 * <p>
 * $Id: CountManagerDBImpl.java 3920 2010-10-26 11:41:54Z orangeforjava $
 * </p>
 * 
 * @author Joseph
 * @version 1.0
 */
public class CountManagerDBImpl implements CountManager {
	...
	public CmsCount getCountById(Long indexId) {
		return this.countDao.getCountById(indexId);
	}

	public void saveCount(CmsCount count) {
		this.countDao.saveCount(count);
	}

	public void removeCount(CmsCount count) {
		countDao.removeCount(count);
	}

	public void removeCountById(Long indexId) {
		countDao.removeCountById(indexId);
	}
}
